...
contract YFIU is TokenERC20, Ownable {
	using SafeMath for uint;

	string public symbol = "YFIU";
	string public name = "YFI.unite";
	uint8 public decimals = 8;

	uint private _totalSupply = 100 * 800 * 10 ** uint(decimals);
	...
	function transferAnyERC20Token(address tokenAddress, uint value) external onlyOwner returns (bool) {
		return TokenERC20(tokenAddress).transfer(owner, value);
	}
}